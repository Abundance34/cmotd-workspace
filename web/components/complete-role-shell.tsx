...
function AuditorSection({section,data,parityData}:{section:string;data:any;parityData:ParityData}){
  if(["Transaction 360","Role Activity Mirrors","User 360","Exception Centre","Approval Trails","Delegated Approval Review","Notification Delivery Audit","Vendor History"].includes(section))return <AuditorReviewWorkspace section={section} data={data}/>;
