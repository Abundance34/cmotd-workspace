...
export function AppShell({ user, preview = false, facilityData, procurementData, approverData, securityStatus }: {
  user: ShellUser;
  preview?: boolean;
