...
const runtime = [shell, parity, logistics, draft, appPage].join("\n");
...
console.log(`ProcureFlow feature-parity guard passed: ${sections.length} navigation sections mapped; draft attachments connected; stale migration warnings absent from production runtime.`);
