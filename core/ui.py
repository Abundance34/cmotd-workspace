...
def inject_css():
    ...
    # ProcureFlow intentionally uses one authoritative light theme.  The fixed
    # palette below is applied last so browser/operating-system dark preferences
    # cannot re-colour Streamlit widgets or revive legacy mixed-theme surfaces.
    st.markdown(r"""
    <style>
    :root,
    html,
    ...
    body[data-pf-theme="dark"] {
        ...
        --primary-color: #1769e8 !important;
        --pf-live-bg: #f7f9fc;
        --pf-live-surface: #ffffff;
        --pf-live-text: #172033;
        --pf-live-primary: #1769e8;
        --pf-live-raised: #ffffff;
        --pf-live-raised-2: #f3f6fa;
        --pf-live-border: #dbe3ee;
        --pf-live-border-strong: #c7d2e2;
        --pf-live-muted: #66758c;
        --pf-live-soft-primary: #eaf2ff;
        --pf-live-shadow: 0 8px 24px rgba(16, 36, 66, .075);
        --pf-bg: #f7f9fc;
        --pf-surface: #ffffff;
        --pf-surface-2: #f3f6fa;
        --pf-input: #ffffff;
        --pf-text-primary: #172033;
        --pf-text-secondary: #34425a;
        --pf-text-muted: #66758c;
        --pf-border-token: #dbe3ee;
        --pf-border-strong: #c7d2e2;
        --pf-brand: #1769e8;
        --pf-brand-strong: #0b52c4;
    ...
    [data-testid="stApp"] small,
    [data-testid="stApp"] .pf-muted {
        color: #66758c !important;
    }

    /* Header and command bar */
    [data-testid="stApp"] .pf-native-breadcrumb,
    [data-testid="stApp"] .pf-native-breadcrumb strong,
    [data-testid="stApp"] .pf-native-profile-copy b,
    [data-testid="stApp"] .pf-reference-breadcrumb,
    [data-testid="stApp"] .pf-reference-user-copy b {
        color: #172033 !important;
    }
    [data-testid="stApp"] .pf-native-breadcrumb b,
    [data-testid="stApp"] .pf-reference-breadcrumb b {
        color: #1769e8 !important;
    }
    [data-testid="stApp"] .pf-native-breadcrumb span,
    [data-testid="stApp"] .pf-native-profile-copy span,
    [data-testid="stApp"] .pf-native-chevron,
    [data-testid="stApp"] .pf-reference-breadcrumb span,
    [data-testid="stApp"] .pf-reference-user-copy span,
    [data-testid="stApp"] .pf-reference-chevron {
        color: #66758c !important;
    }
    [data-testid="stApp"] .pf-native-search,
    [data-testid="stApp"] .pf-native-bell,
    [data-testid="stApp"] .pf-reference-search,
    [data-testid="stApp"] .pf-reference-icon,
    [data-testid="stApp"] .pf-native-profile,
    [data-testid="stApp"] div[class*="st-key-pf_sidebar_toggle"] button,
    [data-testid="stApp"] div[class*="st-key-pf-sidebar-toggle"] button {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #dbe3ee !important;
        box-shadow: 0 2px 8px rgba(16, 36, 66, .045) !important;
    }
    [data-testid="stApp"] .pf-native-search kbd,
    [data-testid="stApp"] .pf-reference-search kbd {
        background: #f3f6fa !important;
        color: #66758c !important;
        border-color: #dbe3ee !important;
    }
    [data-testid="stApp"] .pf-native-header-divider,
    [data-testid="stApp"] .pf-reference-topbar {
        border-color: #dbe3ee !important;
    }
    [data-testid="stApp"] .pf-native-header-divider {
    ...
    [data-testid="stApp"] .pf-hero {
        ...
        background:
            radial-gradient(circle at 91% 24%, rgba(23, 105, 232, .15), transparent 25%),
            linear-gradient(135deg, #ffffff 0%, #f1f6ff 100%) !important;
        box-shadow: 0 8px 24px rgba(16, 36, 66, .07) !important;
    }
    [data-testid="stApp"] .pf-hero::after {
        opacity: .24 !important;
        filter: none !important;
    }
    [data-testid="stApp"] .pf-hero h1 {
        color: #10203a !important;
        text-shadow: none !important;
    }
    [data-testid="stApp"] .pf-hero p {
        color: #56657a !important;
        text-shadow: none !important;
    }
    [data-testid="stApp"] div[data-testid="stMetric"],
    [data-testid="stApp"] [data-testid="stForm"],
    [data-testid="stApp"] div[data-testid="stVerticalBlockBorderWrapper"],
    [data-testid="stApp"] div[data-testid="stExpander"],
    [data-testid="stApp"] [data-testid="stFileUploaderDropzone"],
    [data-testid="stApp"] [data-testid="stJson"],
    [data-testid="stApp"] [data-testid="stTable"],
    [data-testid="stApp"] .pf-card {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #dbe3ee !important;
        box-shadow: 0 6px 18px rgba(16, 36, 66, .06) !important;
    }
    [data-testid="stApp"] div[data-testid="stMetric"] {
        min-height: 116px !important;
    }
    [data-testid="stApp"] div[data-testid="stMetric"]::before {
        background: #eaf2ff !important;
        color: #1769e8 !important;
        border: 1px solid #c8dcff !important;
        box-shadow: none !important;
    }
    [data-testid="stApp"] div[data-testid="stMetric"] label,
    [data-testid="stApp"] div[data-testid="stMetric"] [data-testid="stMetricLabel"] p {
        color: #66758c !important;
    }
    [data-testid="stApp"] div[data-testid="stMetric"] [data-testid="stMetricValue"],
    [data-testid="stApp"] div[data-testid="stMetric"] [data-testid="stMetricValue"] > div {
        color: #10203a !important;
        opacity: 1 !important;
        text-shadow: none !important;
    }
    [data-testid="stApp"] div[data-testid="stExpander"] details,
    [data-testid="stApp"] div[data-testid="stExpander"] summary,
    [data-testid="stApp"] div[data-testid="stExpander"] details > div {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #dbe3ee !important;
    }
    [data-testid="stApp"] [data-testid="stExpanderDetails"],
    [data-testid="stApp"] div[data-testid="stExpander"] details > div:not(summary) {
        padding: .9rem 1rem 1.05rem !important;
        box-sizing: border-box !important;
    }

    /* Read-only detail cards remain clear and high contrast without looking
       like disabled form controls. */
    [data-testid="stApp"] .pf-detail-field {
        min-height: 68px;
        margin: 0 0 .75rem;
        padding: .72rem .85rem;
    ...
    [data-testid="stApp"] .pf-detail-field-label {
        display: block;
        margin-bottom: .28rem;
        color: #64748b !important;
        font-size: .76rem;
    ...
    [data-testid="stApp"] .pf-detail-field-value {
        display: block;
        color: #172033 !important;
        font-size: .94rem;
        font-weight: 750;
    ...
    /* Forms and controls */
    [data-testid="stApp"] div[data-baseweb="input"] > div,
    [data-testid="stApp"] div[data-baseweb="select"] > div,
    [data-testid="stApp"] div[data-baseweb="base-input"],
    [data-testid="stApp"] [data-testid="stTextArea"] textarea,
    [data-testid="stApp"] [data-testid="stNumberInput"] input,
    [data-testid="stApp"] [data-testid="stDateInput"] input,
    [data-testid="stApp"] [data-testid="stTextInput"] input,
    [data-testid="stApp"] [data-testid="stTimeInput"] input {
        background: #ffffff !important;
        color: #172033 !important;
        border: 1px solid #b8c6d8 !important;
        border-color: #b8c6d8 !important;
        box-shadow: inset 0 0 0 1px rgba(184,198,216,.18) !important;
        opacity: 1 !important;
    }
    [data-testid="stApp"] div[data-baseweb="input"] > div:hover,
    [data-testid="stApp"] div[data-baseweb="select"] > div:hover,
    [data-testid="stApp"] [data-testid="stTextArea"] textarea:hover {
        border-color: #7f9cc2 !important;
    }
    [data-testid="stApp"] div[data-baseweb="input"] > div:focus-within,
    [data-testid="stApp"] div[data-baseweb="select"] > div:focus-within,
    [data-testid="stApp"] div[data-baseweb="base-input"]:focus-within,
    [data-testid="stApp"] [data-testid="stTextArea"] textarea:focus,
    [data-testid="stApp"] [data-testid="stNumberInput"] input:focus,
    [data-testid="stApp"] [data-testid="stDateInput"] input:focus,
    [data-testid="stApp"] [data-testid="stTextInput"] input:focus,
    [data-testid="stApp"] [data-testid="stTimeInput"] input:focus {
        outline: none !important;
        border-color: #1769e8 !important;
        box-shadow: 0 0 0 3px rgba(23,105,232,.16), inset 0 0 0 1px #1769e8 !important;
    }
    [data-testid="stApp"] input::placeholder,
    [data-testid="stApp"] textarea::placeholder {
    ...
    [data-testid="stApp"] [role="tooltip"] {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #dbe3ee !important;
    }
    ...
    [data-testid="stApp"] [role="option"]:hover,
    [data-testid="stApp"] [role="option"][aria-selected="true"] {
        background: #eaf2ff !important;
        color: #0b52c4 !important;
    }
    ...
    [data-testid="stApp"] input:disabled,
    [data-testid="stApp"] textarea:disabled,
    [data-testid="stApp"] button:disabled,
    [data-testid="stApp"] [aria-disabled="true"] {
        background: #f3f6fa !important;
        color: #3f4d63 !important;
        -webkit-text-fill-color: #3f4d63 !important;
        border-color: #c6d2e1 !important;
        opacity: 1 !important;
    }

    /* Data tables and dataframe shells */
    [data-testid="stApp"] [data-testid="stDataFrame"],
    [data-testid="stApp"] [data-testid="stMarkdownContainer"] table {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #dbe3ee !important;
    }
    [data-testid="stApp"] [data-testid="stDataFrame"] [role="columnheader"],
    [data-testid="stApp"] [data-testid="stMarkdownContainer"] table th {
        background: #f3f6fa !important;
        color: #536177 !important;
        border-color: #dbe3ee !important;
    }
    [data-testid="stApp"] [data-testid="stDataFrame"] [role="gridcell"],
    [data-testid="stApp"] [data-testid="stMarkdownContainer"] table td {
        background: #ffffff !important;
        color: #172033 !important;
        border-color: #e4eaf2 !important;
    }
    [data-testid="stApp"] [data-testid="stMarkdownContainer"] table tbody tr:hover td {
        background: #f1f6ff !important;
    }
    [data-testid="stApp"] button[data-baseweb="tab"] {
        color: #66758c !important;
        background: transparent !important;
    }
    [data-testid="stApp"] button[data-baseweb="tab"]:hover,
    [data-testid="stApp"] button[data-baseweb="tab"][aria-selected="true"] {
        color: #0b52c4 !important;
        background: #eaf2ff !important;
    }
    ...
    /* Fixed branded sidebar. Navigation buttons stay blue/transparent rather
       than inheriting the white secondary-button treatment used in main pages. */
    section[data-testid="stSidebar"],
    section[data-testid="stSidebar"] > div:first-child {
        background: linear-gradient(180deg, #0d58bd 0%, #0a469a 52%, #073477 100%) !important;
    }
    section[data-testid="stSidebar"] {
        border-right: 1px solid rgba(6, 44, 101, .22) !important;
        box-shadow: 7px 0 24px rgba(17, 45, 88, .12) !important;
    }
    /* Do not depend on Streamlit's generated key-wrapper classes here.  They
       vary by release.  The sidebar container plus the stable button kind and
       data-testid attributes keep navigation readable across versions. */
    [data-testid="stApp"] section[data-testid="stSidebar"] .stButton > button,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[kind="secondary"],
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="baseButton-secondary"],
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="stBaseButton-secondary"] {
        background: transparent !important;
    ...
    [data-testid="stApp"] section[data-testid="stSidebar"] button[kind="primary"],
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="baseButton-primary"],
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="stBaseButton-primary"] {
        background: linear-gradient(90deg, #063d99 0%, #0b5dcc 100%) !important;
        background-color: #0b5dcc !important;
        color: #ffffff !important;
        border-color: rgba(255, 255, 255, .32) !important;
        box-shadow: inset 0 1px 0 rgba(255, 255, 255, .14), 0 6px 16px rgba(1, 38, 101, .24) !important;
    }
    [data-testid="stApp"] section[data-testid="stSidebar"] .stButton > button:hover,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[kind="secondary"]:hover,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="baseButton-secondary"]:hover,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="stBaseButton-secondary"]:hover {
        background: rgba(255, 255, 255, .14) !important;
        background-color: rgba(255, 255, 255, .14) !important;
        color: #ffffff !important;
        border-color: rgba(255, 255, 255, .18) !important;
    }
    [data-testid="stApp"] section[data-testid="stSidebar"] button[kind="primary"]:hover,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="baseButton-primary"]:hover,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid="stBaseButton-primary"]:hover {
        background: linear-gradient(90deg, #063d99 0%, #0b5dcc 100%) !important;
        background-color: #0b5dcc !important;
        color: #ffffff !important;
        border-color: rgba(255, 255, 255, .38) !important;
    }
    [data-testid="stApp"] section[data-testid="stSidebar"] .stButton > button p,
    [data-testid="stApp"] section[data-testid="stSidebar"] .stButton > button span,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid^="baseButton-"] p,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid^="baseButton-"] span,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid^="stBaseButton-"] p,
    [data-testid="stApp"] section[data-testid="stSidebar"] button[data-testid^="stBaseButton-"] span,
    [data-testid="stApp"] section[data-testid="stSidebar"] .pf-sidebar-product,
    [data-testid="stApp"] section[data-testid="stSidebar"] .pf-sidebar-caption,
    [data-testid="stApp"] section[data-testid="stSidebar"] .pf-sidebar-nav-label {
        color: #ffffff !important;
        opacity: 1 !important;
    }

    @media (max-width: 780px) {
        [data-testid="stApp"] .pf-hero { padding: 20px !important; }
        [data-testid="stApp"] div[data-testid="stMetric"] { min-height: 104px !important; }
    }
    </style>
    """, unsafe_allow_html=True)
...
def badge(status: str | None) -> str:
    ...
    lower = status.lower()
    if any(token in lower for token in ["approved", "paid", "completed", "verified", "active", "received", "matched"]):
        semantic, symbol = "success", "✓"
    elif any(token in lower for token in ["rejected", "failed", "cancelled", "disputed", "rescinded"]):
        semantic, symbol = "danger", "!"
    elif any(token in lower for token in ["pending", "review", "returned", "sourcing", "warning"]):
        semantic, symbol = "warning", "•"
    else:
        semantic, symbol = "info", "•"
    return f'<span class="pf-badge pf-status-{semantic}" style="color:{fg}; background:{bg};"><span aria-hidden="true">{symbol}</span>{html.escape(display_status)}</span>'
