...
SMTP_USER = os.environ.get("PROCUREFLOW_SMTP_USERNAME", os.environ.get("PROCUREFLOW_SMTP_USER", ""))
SMTP_PASSWORD = os.environ.get("PROCUREFLOW_SMTP_PASSWORD", "")

SMTP_FROM = os.environ.get("PROCUREFLOW_SMTP_FROM", os.environ.get("SMTP_FROM", ""))
